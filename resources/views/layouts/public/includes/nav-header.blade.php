          ...
          <nav class="js-mega-menu navbar navbar-expand-lg g-px-0">
            <div class="container g-px-15">
              ...
              <a class="navbar-brand g-hidden-lg-up" href="bm-classic-home-page-1.html">
                <img src="{{asset('unify/assets/img/logo.png')}}" alt="Logo">
              </a>
              <!-- End Logo -->
                    ...
                    <ul id="nav-submenu--home" class="hs-sub-menu list-unstyled u-shadow-v11 g-min-width-220 g-brd-top g-brd-primary g-brd-top-2 g-mt-17"
                      ...
                      <li class="dropdown-item g-bg-secondary--hover">
                        <a class="nav-link g-color-secondary-dark-v1" href="bm-classic-home-page-2.html">Home Option 2
                          <span class="u-label g-rounded-3 g-font-size-10 g-bg-lightred g-pos-rel g-top-minus-1 g-py-3 g-ml-5">New</span>
                        </a>
                      </li>
                      <li class="dropdown-item g-bg-secondary--hover">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-5">
                          <article class="media g-mb-20">
                            <a class="d-flex mr-3" href="#!"><img class="g-width-120 g-height-70" src="{{asset('unify/assets/img-temp/500x320/img1.jpg')}}" alt="Image Description"></a>
                            <div class="media-body">
                              <h3 class="h6">
                          ...
                          <article class="media g-mb-20">
                            <a class="d-flex mr-3" href="#!"><img class="g-width-120 g-height-70" src="{{asset('unify/assets/img-temp/500x320/img2.jpg')}}" alt="Image Description"></a>
                            <div class="media-body">
                              <h3 class="h6">
                          ...
                          <article class="media g-mb-20">
                            <a class="d-flex mr-3" href="#!"><img class="g-width-120 g-height-70" src="{{asset('unify/assets/img-temp/500x320/img3.jpg')}}" alt="Image Description"></a>
                            <div class="media-body">
                              <h3 class="h6">
                        ...
                        <div class="col-lg-4">
                          <article>
                            <figure class="g-pos-rel">
                              <img class="img-fluid w-100 g-mb-20" src="{{asset('unify/assets/img-temp/900x600/img7.jpg')}}" alt="Image Description">
                            </figure>
                    ...
                    <div class="hs-mega-menu u-shadow-v11 g-text-transform-none g-font-weight-400 g-brd-top g-brd-primary g-brd-top-2 g-bg-white g-left-15 g-right-15 g-pa-30 g-mt-17 g-mt-7--lg--scrolling" aria-labelledby="mega-menu-label-4">
                      <div class="row">
                        <div class="col-lg-4">
                          <article class="u-block-hover">
                            <figure class="g-bg-cover g-bg-black-gradient-opacity-v1--after">
                              <img class="img-fluid u-block-hover__main--zoom-v1" src="{{asset('unify/assets/img-temp/500x320/img1.jpg')}}" alt="Image Description">
                            </figure>
                        ...
                        <div class="col-lg-4">
                          <article class="u-block-hover">
                            <figure class="g-bg-cover g-bg-black-gradient-opacity-v1--after">
                              <img class="img-fluid u-block-hover__main--zoom-v1" src="{{asset('unify/assets/img-temp/500x320/img2.jpg')}}" alt="Image Description">
                            </figure>
                            <span class="g-pos-abs g-top-20 g-left-20">
                        ...
                        <div class="col-lg-4">
                          <article class="u-block-hover">
                            <figure class="g-bg-cover g-bg-black-gradient-opacity-v1--after">
                              <img class="img-fluid u-block-hover__main--zoom-v1" src="{{asset('unify/assets/img-temp/500x320/img3.jpg')}}" alt="Image Description">
                            </figure>
                            <span class="g-pos-abs g-top-20 g-left-20">
                    ...
                    <div class="hs-mega-menu u-shadow-v11 g-text-transform-none g-font-weight-400 g-brd-top g-brd-primary g-brd-top-2 g-bg-white g-left-15 g-right-15 g-pa-30 g-mt-17 g-mt-7--lg--scrolling" aria-labelledby="mega-menu-label-6">
                      <div class="row">
                        <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                          <article class="u-block-hover">
                            <figure class="g-bg-cover g-bg-black-gradient-opacity-v1--after">
                              <img class="img-fluid w-100 u-block-hover__main--zoom-v1" src="{{asset('unify/assets/img-temp/500x320/img1.jpg')}}" alt="Image Description">
                            </figure>
                            <span class="g-pos-abs g-top-20 g-left-20">
                        ...
                        <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                          <article class="u-block-hover">
                            <figure class="g-bg-cover g-bg-black-gradient-opacity-v1--after">
                              <img class="img-fluid w-100 u-block-hover__main--zoom-v1" src="{{asset('unify/assets/img-temp/500x320/img3.jpg')}}" alt="Image Description">
                            </figure>
                            <span class="g-pos-abs g-top-20 g-left-20">
                            <a class="btn btn-sm u-btn-red rounded-0" href="#!">
                              <i class="icon-energy"></i>
                        ...
                        <div class="col-lg-4 g-mb-30 g-mb-0--lg">
                          <article class="u-block-hover">
                            <figure class="g-bg-cover g-bg-black-gradient-opacity-v1--after">
                              <img class="img-fluid w-100 u-block-hover__main--zoom-v1" src="{{asset('unify/assets/img-temp/500x320/img2.jpg')}}" alt="Image Description">
                            </figure>
                            <span class="g-pos-abs g-top-20 g-left-20">
                            <a class="btn btn-sm u-btn-red rounded-0" href="#!">
                              <i class="icon-energy"></i>
